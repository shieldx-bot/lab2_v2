...
require (
	...
	k8s.io/component-helpers v0.34.4
	k8s.io/klog/v2 v2.130.1
	k8s.io/kube-scheduler v0.34.4
...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.34.4
...
replace k8s.io/externaljwt => k8s.io/externaljwt v0.34.4

replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.34.4

replace k8s.io/sample-controller => k8s.io/sample-controller v0.34.4
